...
/***/ function(module, exports, __webpack_require__) {
	...
	Card = (function() {
	  ...
	  Card.prototype.handleInitialPlaceholders = function() {
	    ...
	    if (this.options.placeholders.number) {
	      return this.handlers.setCardType.call(this, null, {
	        data: Payment.fns.cardType(this.options.placeholders.number)
	      });
	    }
	  };
