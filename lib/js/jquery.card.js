...
Card = (function() {
  ...
  Card.prototype.render = function() {
    ...
    if (typeof navigator !== "undefined" && navigator !== null ? navigator.userAgent : void 0) {
      ...
      if (ua.indexOf('safari') !== -1 && ua.indexOf('chrome') === -1) {
        QJ.addClass(this.$card, 'safari');
      }
    }
    if (new Function("/*@cc_on return @_jscript_version; @*/")()) {
      QJ.addClass(this.$card, 'ie-10');
    }
    if (/rv:11.0/i.test(navigator.userAgent)) {
      return QJ.addClass(this.$card, 'ie-11');
    }
  };
  ...
  Card.prototype.handlers = {
    setCardType: function($el, e) {
      ...
      if (!QJ.hasClass(this.$card, cardType)) {
        QJ.removeClass(this.$card, 'unknown');
        QJ.removeClass(this.$card, this.cardTypes.join(' '));
        QJ.addClass(this.$card, cardType);
        QJ.toggleClass(this.$card, 'identified', cardType !== 'unknown');
        return this.cardType = cardType;
      }
    },
    flipCard: function() {
      return QJ.addClass(this.$card, 'flipped');
    },
    unflipCard: function() {
      return QJ.removeClass(this.$card, 'flipped');
    },
  ...
  bindVal = function(el, out, opts) {
    ...
    QJ.on(el, 'focus', function() {
      return QJ.addClass(out, 'focused');
    });
    QJ.on(el, 'blur', function() {
      return QJ.removeClass(el, 'focused');
    });
...
},{"./payment/src/payment.coffee":7,"node.extend":1,"qj":4}],6:[function(_dereq_,module,exports){
var $, Card,
  __slice = [].slice;
...
},{"./card":5}],7:[function(_dereq_,module,exports){
(function (global){
